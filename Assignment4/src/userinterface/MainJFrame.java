...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/food.png"))); // NOI18N
       ...
       UserAccount ua = system.getUserAccountDirectory().authenticateUser(userNameJTextField.getText(), passwordField.getText());  
         try {
             if(ua==null){
                 ...
                 JOptionPane.showMessageDialog(null,"Either Invalid User Name or Invalid Password or both.");
